...
<body bgColor="#D5D5D5">
	<div class="container">
		<p class="c_roomTop"><b>${roomNo} - [Leader]</b></p>
		...
		<div>
			...
			<table width="100%" border="0">
				<q:forEach items="${talk}" var="t">
					<q:if test="${t.username eq 'apple'}">
						...
						<tr>
							<td>
								<form method="POST" action="del2.link?no=${t.no}&roomNo=${roomNo}" enctype="multipart/form-data">
									<input class="c_downImg" type="image" src="cross.svg"/>
								</form>
							</td>
					...
					<q:if test="${t.username eq 'banana'}">
						...
						<tr>
							...
							<td align="right" width="10px">
								<form method="POST" action="del2.link?no=${t.no}&roomNo=${roomNo}">
									<input class="c_downImg" type="image" src="cross.svg"/>
								</form>
							</td>
						</tr>
			...
			<form method="POST" action="add111.link?roomNo=${roomNo}" enctype="multipart/form-data">
				<div align="right">
