...
<style type="text/css">
	...
	@media (min-width:768px) {
		...
		.c_showip_apple { font-size: 10px; padding-left: 10px; width: 270px; }
		.c_showip_banana { font-size: 10px; padding-right: 10px; width: 270px; }
		.c_textBtn { width: 100%; height: 50px; font-size:20px; }
	...
	@media (min-width:992px) {
		...
		.apple_box { font-size: 20px; text-align: left; height: 50px; padding-left: 12px; padding-top: 5px; padding-bottom: 5px; position: relative; border-radius: 0.4em; }
		.banana_box { font-size: 20px; text-align: right; height: 50px; padding-right: 12px; padding-top: 5px; padding-bottom: 5px; position: relative; border-radius: 0.4em; }
		.c_showip_apple { font-size: 10px; padding-left: 10px; width: 450px; }
		.c_showip_banana { font-size: 10px; padding-right: 10px; width: 450px; }
		.c_textBtn { width: 100%; height: 50px; font-size:20px; }
		.c_downImg { width: 20px; height: 20px; }
	}
	/* lg */
	@media (min-width:1200px) {
		...
		.apple_box { font-size: 20px; text-align: left; height: 50px; padding-left: 12px; padding-top: 5px; padding-bottom: 5px; position: relative; border-radius: 0.4em; }
		.banana_box { font-size: 20px; text-align: right; height: 50px; padding-right: 12px; padding-top: 5px; padding-bottom: 5px; position: relative; border-radius: 0.4em; }
		.c_showip_apple { font-size: 10px; padding-left: 10px; width: 750px; }
		.c_showip_banana { font-size: 10px; padding-right: 10px; width: 750px; }
		.c_textBtn { width: 100%; height: 50px; font-size:20px; }
		.c_downImg { width: 20px; height: 20px; }
	}
</style>
...
<body>
	<div class="container">
		<p class="c_roomTop"><b>${roomNo} - [Guest]</b></p>
